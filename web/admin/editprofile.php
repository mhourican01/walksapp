		...
		<div class="container">
						...
						<?php
							...
							while($userrow = $userresult->fetch_assoc()) {
								...
								$useremail = $userrow['email_address'];
								...
								<div class='row'>
									...
									<div class='field'>
										<div class='control'>
											<input value='$useremail' type='email' name='newemail'";?> required <?php echo ">
										</div>
									</div>
									</div>
									...
									<div class='field'>
										<div class='control'>
											<input value='$userpw' type='password' name='newpw'";?> required <?php echo ">
										</div>
									</div>
									</div>
								";
